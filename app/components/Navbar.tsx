        ...
        >
            ...
            <motion.div
                ...
                style={{
                    width: 18,
                    height: 18,
                    background: isDark ? "rgba(255,255,255,0.85)" : "rgba(30,25,20,0.82)",
                }}
            >
                {/* Icon inside knob */}
                <motion.div
                ...
                >
                    {isDark ? (
                        <svg width="9" height="9" viewBox="0 0 24 24" fill="none"
                            stroke="rgba(30,25,20,0.8)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                            <path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z" />
                        </svg>
                    ) : (
                        <svg width="9" height="9" viewBox="0 0 24 24" fill="none"
                            stroke="rgba(255,250,240,0.9)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
